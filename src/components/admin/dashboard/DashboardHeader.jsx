    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div>
                    <h1 className="text-3xl font-bold text-gray-900">Pontaj pe perioada</h1>
                    <p className="text-gray-500 mt-1">
                        Situatie zilnica clara pentru data selectata: <span className="font-medium">{selectedDate}</span>
                    </p>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-5 gap-4">
                ...
                <Card>
                    <CardContent className="pt-6">
                        <div className="flex items-center justify-between">
                            <div>
                                <p className="text-sm text-gray-500">Absenti Motivati</p>
                                <p className="text-3xl font-bold mt-1 text-sky-600">{justifiedAbsentCount}</p>
                            </div>
                ...
                <Card>
                    <CardContent className="pt-6">
                        <div className="flex items-center justify-between">
                            <div>
                                <p className="text-sm text-gray-500">Absenti Nemotivati</p>
                                <p className="text-3xl font-bold mt-1 text-red-600">{unjustifiedAbsentCount}</p>
                            </div>
